import z from "dayjs";
import { inject as Le, computed as Y, defineComponent as se, openBlock as S, createElementBlock as F, Fragment as ge, renderList as we, unref as B, normalizeStyle as U, renderSlot as j, createElementVNode as N, toDisplayString as ie, createTextVNode as xe, createCommentVNode as te, toRefs as ke, ref as L, watch as $e, nextTick as Ke, createBlock as ve, Teleport as gt, createVNode as Fe, Transition as pt, withCtx as re, getCurrentScope as bt, onScopeDispose as yt, getCurrentInstance as wt, onMounted as He, useSlots as xt, onUnmounted as kt, provide as Ce, normalizeClass as Ye, withModifiers as Et, mergeProps as Dt, TransitionGroup as Bt } from "vue";
var ce = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, Je = { exports: {} };
(function(e, m) {
  (function(t, r) {
    e.exports = r();
  })(ce, function() {
  ...
  (function(t, r) {
    ...
    function D(l) {
      ...
      for (var p = (l = x.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g, function(R, $, A) {
        ...
        return $ || k[A] || t[A] || k[I].replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g, function(Q, q, G) {
          return q || G.slice(1);
        });
      ...
      return function(R) {
        for (var $ = {}, A = 0, I = 0; A < O; A += 1) {
          ...
          if (typeof Q == "string")
            ...
            var q = Q.regex, G = Q.parser, P = R.slice(I), W = q.exec(P)[0];
            G.call($, W), R = R.replace(W, "");
          }
        }
        return function(J) {
          var de = J.afternoon;
...
const Lt = ot.exports, it = Symbol("CHART_ROWS_KEY"), st = Symbol("CONFIG_KEY"), lt = Symbol("EMIT_BAR_EVENT_KEY"), ut = Symbol("BAR_CONTAINER_KEY");
function Z() {
  const e = Le(st);
  if (!e)
...
function Ee(e = Z()) {
  const { chartStart: m, chartEnd: t, barStart: r, barEnd: g, dateFormat: f } = e, u = Y(() => i(m.value)), o = Y(() => i(t.value)), i = (a, c) => {
    let h;
...
function ct() {
  const { precision: e } = Z(), { chartStartDayjs: m, chartEndDayjs: t } = Ee(), r = Y(() => {
...
const $t = { class: "g-grid-container" }, Gt = /* @__PURE__ */ se({
  __name: "GGanttGrid",
  props: {
    highlightedUnits: {}
  },
  setup(e) {
    const { colors: m } = Z(), { timeaxisUnits: t } = ct();
    return (r, g) => (S(), F("div", $t, [
...
const Yt = { class: "g-label-column-rows" }, Rt = /* @__PURE__ */ se({
...
const It = { class: "g-timeaxis" }, Ft = { class: "g-timeunits-container" }, Ht = { class: "g-timeunits-container" }, At = /* @__PURE__ */ se({
  __name: "GGanttTimeaxis",
  setup(e) {
    const { precision: m, colors: t } = Z(), { timeaxisUnits: r } = ct();
    return (g, f) => (S(), F("div", It, [
      N("div", Ft, [
...
const Pt = "cadetblue", Wt = /* @__PURE__ */ se({
  ...
  setup(e) {
    ...
    const c = Y(() => {
      var l, x;
      return ((x = (l = r == null ? void 0 : r.value) == null ? void 0 : l.style) == null ? void 0 : x.background) || Pt;
    }), { toDayjs: h } = Ee(), b = Y(() => {
      var l;
...
function Ge(e = Z()) {
  const { dateFormat: m, chartSize: t } = e, { chartStartDayjs: r, chartEndDayjs: g, toDayjs: f, format: u } = Ee(e), o = Y(() => g.value.diff(r.value, "minutes"));
  return {
    mapTimeToPosition: (a) => {
...
const zt = /* @__PURE__ */ se({
  ...
  setup(e) {
    const { mapTimeToPosition: m } = Ge(), t = L(z()), { colors: r, dateFormat: g, currentTimeLabel: f } = Z(), u = Y(() => {
...
De && ((ze = window == null ? void 0 : window.navigator) == null ? void 0 : ze.userAgent) && /iP(ad|hone|od)/.test(window.navigator.userAgent);
function jt(e) {
...
Re[Ie] = Re[Ie] || {};
Re[Ie];
var je = Object.getOwnPropertySymbols, qt = Object.prototype.hasOwnProperty, Qt = Object.prototype.propertyIsEnumerable, Zt = (e, m) => {
  var t = {};
  for (var r in e)
    qt.call(e, r) && m.indexOf(r) < 0 && (t[r] = e[r]);
  if (e != null && je)
    for (var r of je(e))
      m.indexOf(r) < 0 && Qt.call(e, r) && (t[r] = e[r]);
  return t;
};
function Kt(e, m, t = {}) {
  const r = t, { window: g = dt } = r, f = Zt(r, ["window"]);
  let u;
  const o = Vt(() => g && "ResizeObserver" in g), i = () => {
...
function Jt(e, m = { width: 0, height: 0 }, t = {}) {
  const { window: r = dt, box: g = "content-box" } = t, f = Y(() => {
    var i, s;
...
var en = Object.defineProperty, Ne = Object.getOwnPropertySymbols, tn = Object.prototype.hasOwnProperty, nn = Object.prototype.propertyIsEnumerable, Xe = (e, m, t) => m in e ? en(e, m, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[m] = t, rn = (e, m) => {
  for (var t in m || (m = {}))
    tn.call(m, t) && Xe(e, t, m[t]);
  if (Ne)
    for (var t of Ne(m))
      nn.call(m, t) && Xe(e, t, m[t]);
  return e;
};
const an = {
...
const Ve = {
...
}, on = { class: "g-gantt-rows-container" }, sn = 250, qe = 0.05, Qe = 10, ln = 250, ft = /* @__PURE__ */ se({
  __name: "GGanttChart",
  props: {
    chartStart: {},
    chartEnd: {},
  ...
  setup(e, { emit: m }) {
    const t = e, r = m, { width: g, font: f, colorScheme: u } = ke(t), o = xt(), i = Y(
      () => typeof u.value != "string" ? u.value : Ve[u.value] || Ve.default
    ), s = () => {
      var T;
        ...
        if ((H = C.props) != null && H.bars) {
          ...
          Array.isArray(C.children) && C.children.forEach((ee) => {
            ...
            if ((K = V == null ? void 0 : V.props) != null && K.bars) {
              const { label: ne, bars: We } = V.props;
              M.push({ label: ne, bars: We });
            }
          });
      }), M;
    ...
    }, k = L(null), p = Jt(k), O = L(1), d = L(!1), y = L(0), v = L(0), E = L(!1);
    let _ = null;
    const R = L(0), $ = L(0), A = L(!1), I = Y(() => {
    ...
    }), q = Y(() => Q.value.diff(I.value, "minute")), G = L(0), P = Y(() => q.value / O.value), W = Y(() => I.value.add(G.value, "minute")), J = Y(() => W.value.add(P.value, "minute")), de = Y(() => {
      ...
      if (n.ctrlKey || n.metaKey) {
        ...
        n.preventDefault();
        const M = n.deltaY > 0 ? -0.05 : 0.05, T = Math.max(qe, Math.min(Qe, O.value + M)), C = k.value;
        if (C) {
          const H = C.getBoundingClientRect(), V = (n.clientX - H.left + C.scrollLeft) / (p.width.value || 1), K = W.value.add(V * P.value, "minute");
          O.value = T;
          const ne = q.value / T, vt = K.diff(I.value, "minute") - V * ne;
          G.value = vt;
        }
      }
    }, fe = (n) => {
      ...
      n.button !== 0 || n.target.closest(".g-gantt-bar") || (d.value = !0, E.value = !1, y.value = n.clientX, v.value = G.value, n.preventDefault());
    }, _e = (n) => {
      if (!d.value || !k.value)
        return;
      ...
      n.target.closest(".g-gantt-bar") || (n.touches.length === 2 ? (n.preventDefault(), A.value = !0, R.value = Me(n.touches), $.value = pe(n.touches), v.value = G.value) : n.touches.length === 1 && (A.value = !0, y.value = n.touches[0].clientX, v.value = G.value));
    }, me = (n) => {
      if (!!A.value) {
        if (n.touches.length === 2) {
          n.preventDefault();
          const M = Me(n.touches), T = pe(n.touches), H = (M / R.value - 1) * 0.5, ee = Math.max(qe, Math.min(Qe, O.value * (1 + H))), V = T - $.value, K = (p.width.value || 1) / P.value, ne = -V / K;
          O.value = ee, G.value = v.value + ne, R.value = M, $.value = T, v.value = G.value;
    ...
    return Ce(it, s), Ce(st, {
      ...
      colors: i,
      chartSize: p
    }), Ce(lt, x), (n, M) => (S(), F("div", null, [
      N("div", {
        class: Ye([{ "labels-in-column": !!e.labelColumnTitle }])
      }, [
        e.labelColumnTitle ? (S(), ve(Rt, {
          key: 0,
        ...
        N("div", {
          ref_key: "ganttChart",
          ref: k,
          class: Ye(["g-gantt-chart", { "with-column": e.labelColumnTitle, "is-dragging": d.value }]),
          style: U({ width: B(g), background: i.value.background, fontFamily: B(f) })
        }, [
          e.hideTimeaxis ? te("", !0) : (S(), ve(At, { key: 0 }, {
...
function Ze(e, m = () => null, t = () => null, r = Z()) {
  const { barStart: g, barEnd: f, pushOnOverlap: u } = r, o = L(!1);
  let i = 0, s;
  const { mapPositionToTime: a } = Ge(r), { toDayjs: c } = Ee(r), h = (p) => {
...
function un() {
  const e = Z(), m = Ae(), t = mt(), { pushOnOverlap: r, barStart: g, barEnd: f, noOverlap: u, dateFormat: o } = e, i = /* @__PURE__ */ new Map(), { toDayjs: s, format: a } = Ee(), c = (d, y) => {
    const { initDrag: v } = Ze(d, b, k, e);
    ...
    v != null && (m().forEach((E) => {
      E.bars.forEach((_) => {
        if (_.bundle === v) {
          const R = _ === d ? k : () => null, { initDrag: $ } = Ze(_, b, R, e);
          $(y), p(_);
        }
      });
    ...
    var Q, q;
    let y, v, E;
    const _ = (q = (Q = m().find((G) => G.bars.includes(d))) == null ? void 0 : Q.bars) != null ? q : [], R = s(d[g.value]), $ = s(d[f.value]);
    return { overlapBar: _.find((G) => {
      if (G === d)
        return !1;
      const P = s(G[g.value]), W = s(G[f.value]);
...
const dn = ["id"], fn = { class: "g-gantt-bar-label" }, mn = ["innerHTML"], Pe = /* @__PURE__ */ se({
  __name: "GGanttBar",
  props: {
    bar: {}
  },
  setup(e) {
    const m = e, t = mt(), r = Z(), { rowHeight: g } = r, { bar: f } = ke(m), { mapTimeToPosition: u, mapPositionToTime: o } = Ge(), { initDragOfBar: i, initDragOfBundle: s } = un(), { setDragLimitsOfGanttBar: a } = cn(), c = L(!1);
    function h(E) {
    ...
    return He(() => {
      ...
      id: B(f).id,
      class: Ye(["g-gantt-bar", B(f).class || ""]),
      style: U({
        ...B(f).style,
        position: "absolute",
        top: `${B(g) * 0.1}px`,
...
const ht = /* @__PURE__ */ se({
  ...
  emits: ["drop"],
  setup(e, { emit: m }) {
    const t = e, r = m, { rowHeight: g, colors: f, labelColumnTitle: u } = Z(), { highlightOnHover: o } = ke(t), i = L(!1), s = Y(() => ({
      height: `${g.value}px`,
      background: (o == null ? void 0 : o.value) && i.value ? f.value.hoverHighlight : null
    })), { mapPositionToTime: a } = Ge(), c = L(null);
    Ce(ut, c);
    const h = (w) => {
      var k;
    ...
    return (w, D) => (S(), F("div", {
      class: "g-gantt-row",
      style: U(s.value),
      onDragover: D[0] || (D[0] = Et((l) => i.value = !0, ["prevent"])),
      ...
      N("div", Dt({
        ...
        Fe(Bt, {
          ...
          default: re(() => [
            e.bars ? (S(!0), F(ge, { key: 0 }, we(e.bars, (l) => (S(), ve(Pe, {
              key: l.id,
              bar: l
            }, {
              default: re(() => [
...
Pe.name = "GGanttBar";
function hn() {
  z.extend(Tt), z.extend(Ot), z.extend(Mt), z.extend(Lt), z.extend(Ct), z.extend(_t), z.extend(St);
}
const pn = {
  install(e, m) {
    hn(), e.component("GGanttChart", ft), e.component("GGanttRow", ht), e.component("GGanttBar", Pe);
  }
};
function le(e, m = "top") {
